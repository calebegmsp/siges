                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Cursos cadastrados')}}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('curso.create') }}" class="btn btn-sm btn-primary">{{ __('Cadastrar curso') }}</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($cursos as $curso)
                                    ...
                                    <tr>
                                        ...
                                        <td>R$ {{ number_format($curso->VALORCURSO, 2) }}</td>
                                        <td class="text-right">
                                            <div class="dropdown">
