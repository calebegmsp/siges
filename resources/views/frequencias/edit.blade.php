        ...
        <div class="row">
            <div class="col">
                <div class="card shadow">
                    ...
                    <form method="post" action="{{ route('frequencia.update') }}" autocomplete="off" id="form" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="row" style="padding-left: 1.6em; margin-bottom: 1em">
                            <div class="col-md-3">
                                <label class="form-control-label" for="" id="label-nome">{{ __('Data de lançamento *') }} <span id="aler-exist" style="color: red; display: none;">Já existe!</span></label>
                                <input id="nameAvali" type="date" class="form-control" name="REFERENCIA" placeholder="Ex: Prova 1" onblur="javascript:checkNomeAvaliacao();" required min="3" value="{{$request->REFERENCIA}}" maxlength="10">
                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th style="width: 2em; text-align: center;">{{ __('Faltas') }}</th>
                                   ...
                                   @foreach($alunos as $key => $aluno)
                                        <tr>
                                            ...
                                            <td style="border-left: 1px solid #e9ecef; text-align: center;">
                                                <input style="width: 7em; height: 3em" class="form-control inputNota" type="number" name="NOTA[{{$aluno->CDFREQUENCIA}}][]" value="{{number_format($aluno->FALTAS, 0, '.', ' ')}}" min="0" max="10" step="1" required>
                                            </td>
