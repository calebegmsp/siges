        ...
        <div class="row">
            <div class="col">
                <div class="card shadow">
                    ...
                    <form method="post" action="{{ route('frequencias.store') }}" autocomplete="off" id="form" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="row" style="padding-left: 1.6em; margin-bottom: 1em">
                            <div class="col-md-3">
                                ...
                                <input id="nameAvali" type="date" class="form-control" name="DATA" placeholder="Ex: Prova 1" onblur="javascript:checkNomeAvaliacao();" required min="3" maxlength="10">
                            </div>
                        </div>
                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th style="width: 2em">{{ __('Faltas') }}</th>
                                   ...
                                   @foreach($alunos as $key => $aluno)
                                        <tr>
                                            ...
                                            <td style="border-left: 1px solid #e9ecef; text-align: center;">
                                                <input style="width: 6em; height: 3em; padding-right: 0" class="form-control inputNota" type="number" name="NOTA[{{$aluno->CDMATDISCIPLINA}}][]" min="0" max="8" step="1" required value="0">
                                            </td>
