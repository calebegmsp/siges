@extends('layouts.app', ['title' => __('Edição de cadastro'), "current" => "nota"])
            ...
            <div class="col">
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center" style="margin-bottom: 1em;">
                            <div class="col-md-12">
                                <h4>Clique no semestre, na turma e na disciplina que deseja lançar notas.</h4>
                                            ...
                                            <ul class="nav nav-sm flex-column" style="flex-wrap: nowrap;">
                                                <li class="nav-item">
                                                    ...
                                                    <div class="collapse" id="navbarT-{{$keysem}}{{$keytur}}">
                                                        ...
                                                        <ul class="nav nav-sm flex-column" style="flex-wrap: nowrap;">
                                                            <li class="nav-item">
                                                                <a class="nav-link" style="background-color: #e7f7f7; border: 1px solid #a5a3a3d4; border-radius: 5px; margin-top: 0.2em; margin-left: 1em; width: 97%;" href="{{route('lancarnotas.nota', ['CDSEMESTRE' =>$semestre->CDSEMESTRE, 'CDTURMA' => $turma->CDTURMA, 'CDDISCIPLINA' => $disciplina->CDDISCIPLINA])}}">
