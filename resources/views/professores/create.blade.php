...
@section('content')
    @include('users.partials.header', ['title' => __('Cadastro de professor')])   
        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('professor.store') }}" autocomplete="off" id="form" enctype="multipart/form-data">
                            @csrf
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div id="div-input-election_title">
                                                                <input type="text" name="NOME" id="input-nome" class="form-control" placeholder="{{ __('Digite o nome') }}" required>
                                                            </div>
                                                        </div>
                                                        <div  class="col-md-6">
