@extends('layouts.app', ['title' => __('User Profile'), "current" => "geren-p"])
                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="#" class="btn btn-sm btn-default float-right">{{ __('Contatar') }}</a>
                        </div>
                    </div>
                    <div class="card-body pt-0 pt-md-4">
                            ...
                            <div class="col">
                                <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                    ...
                                    <div>
                                        ...
                                        <span class="description">{{ __('Comentários') }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="text-center">
                            <h3>
                                {{ auth()->user()->name }}<span class="font-weight-light">, 20</span>
                            </h3>
                            <div class="h5 font-weight-300">
                                <i class="ni location_pin mr-2"></i>{{ __('Candiba, Bahia') }}
                            </div>
                            <div class="h5 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>{{ __('Analista e desenvolvedor - Estudante') }}
                            </div>
                            <div>
                                <i class="ni education_hat mr-2"></i>{{ __('IFBaiano - Campus Guanambi') }}
                            </div>
                            <hr class="my-4" />
                            <p>{{ __('Amante de tecnologia') }}</p>
                            <a href="#">{{ __('Ver mais') }}</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="col-12 mb-0">{{ __('Editar as informações da conta') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md">
                                                <div class="form-group">
                                                    <label class="form-control-label" for="input-password-confirmation">{{ __('Confirmação da nova senha') }}</label>
                                                    <input type="password" name="password_confirmation" id="input-password-confirmation" class="form-control form-control-alternative" placeholder="{{ __('Repita a nova senha') }}" value="" required>
                                                </div>        
                                            </div>
                                        </div>
