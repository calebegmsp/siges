        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('turma.store') }}" autocomplete="off" id="form" enctype="multipart/form-data">
                            @csrf
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md">
                                                            ...
                                                            <div id="div-input-election_title">
                                                                <input type="text" name="NOMETURMA" id="input-nome" class="form-control" placeholder="{{ __('Digite o nome') }}">
                                                            </div>
                                                        </div>   
                                                    </div>
                                                </div>
